      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center">
          {investmentCards.map((card, index) => (
            <div
              key={index}
              className="card shadow-lg h-[420px] w-[300px] group rounded-xl relative flex flex-col p-6 z-[1] overflow-hidden bg-white border border-gray-100 transition-all duration-300 hover:shadow-xl"
            >
              {/* Content Container */}
